...
class TestImports(unittest.TestCase):
    ...
    def test_dataclasses_module(self):
        ...
        import laueanalysis.lau_dataclasses
        self.assertTrue(hasattr(laueanalysis.lau_dataclasses, "__file__"))
    ...
    def test_hkls_import(self):
        ...
        from laueanalysis.lau_dataclasses.hkls import HKLs
    ...
    def test_recip_lattice_import(self):
        ...
        from laueanalysis.lau_dataclasses.recipLattice import RecipLattice
