...
class TestImports(unittest.TestCase):
    ...
    def test_dataclasses_module(self):
        ...
        import laueindexing.dataclasses
        self.assertTrue(hasattr(laueindexing.dataclasses, "__file__"))
    ...
    def test_detector_import(self):
        ...
        from laueindexing.dataclasses.detector import Detector
    ...
    def test_roi_import(self):
        ...
        from laueindexing.dataclasses.roi import ROI
    ...
    def test_xtl_import(self):
        ...
        from laueindexing.dataclasses.xtl import Xtl
