...
class TestWireScanInterface:
    """Test the WireScan reconstruction interface functionality."""
    ...
    def test_interface_with_custom_executable(self):
        ...
        with pytest.raises(RuntimeError, match="not found|not working"):
            WireScanReconstructionInterface(wirescan_executable='/nonexistent/path')
    
    def test_reconstruction_with_missing_files(self):
    ...
    def test_reconstruction_parameter_validation(self):
    ...
    def test_batch_reconstruction_interface(self):
